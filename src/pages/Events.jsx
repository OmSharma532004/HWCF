    ...
    return (
        ...
        <div className='flex flex-col items-center mt-5 justify-center w-[80%]'>
            <div className='flex w-full flex-wrap gap-[50px]  items-center justify-around'>
               <img src={i1} alt='event' className='w-[40%] h-[40%] rounded-2xl p-6 bg-pink-400 '/>
               <div className=' w-[400px] flex flex-col items-center justify-center gap-[40px]'>
                <h1 className='text-pink-300 font-semibold font-serif text-4xl'>Conference 2024</h1>
                <p className='text-pink-300 font-extralight  text-lg'>This year’s programme is on 7th & 8th November 2024. We have brought together 20+ speakers from across the world, a mix of academics, health and wellbeing coaches and clinical practitioners for this online event.
                </p>
...
The event is priced at US $75 for this two day event. An early bird fee of US $60 is available until 1 November 2024.
              ...
              <p className='text-pink-300 font-extralight  text-lg' >Attendees will also have the opportunity to access a discount code for a new book exploring the issues of health and wellbeing coaching: The Health & Wellbeing Coaches Handbook. The code will be shared with delegates during the event and will not be available elsewhere. </p>
              </div>
            </div>
