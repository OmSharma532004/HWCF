...
const Section1 = () => {
  return (
    <div 
      className="flex flex-col items-center justify-center gap-6 min-h-screen w-full"
      style={{
        background: 'linear-gradient(135deg, rgba(158, 92, 133, 0.9), rgba(89, 31, 96, 0.9))'
      }}
    >
      <h1 className="text-white font-bold font-mono text-4xl md:text-5xl text-center px-6 md:px-10">
      ...
      <div className="w-full md:w-[60vw] flex flex-col gap-6 items-center justify-center px-6 md:px-10">
        <p className="text-white font-light tracking-wide text-base md:text-lg text-center">
