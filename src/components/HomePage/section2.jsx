...
const Section2 = () => {
    return (
      ...
      <p className="text-purple-800 font-light tracking-wide  text-sm md:text-lg">This definition dove-tails nicely with the broader coaching definitions but also includes patient-led goal setting, socio-education and accountability processes to support healthy behaviors.  </p>
      ...
      <p className="text-purple-800 font-light tracking-wide  text-sm  md:text-lg">"Health & wellbeing coaching is a client centred, non directive conversational approaches which includes health and wellbeing education and health promotion to support clients in identifying and actioning goals enhancing individual wellbeing and healthy life behaviours” (Passmore & Bajaj, 2024).  </p>
                </div>  </div>
    );
}
